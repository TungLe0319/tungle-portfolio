        ...
        <div class="col-md-12 ">
          <p
            v-motion-slide-visible-top
                :delay="300"
          class="display-3 font-1 text-light">Get In Touch</p>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-6 d-flex justify-content-around">
          <a
            v-motion-slide-visible-top
                :delay="300"
          href="mailto:tung.le0319@gmail.com" target="_blank"><button class="btn bg-transparent fs-1 font-1 ">
            <img src="https://cdn-icons-png.flaticon.com/512/732/732200.png" alt="Gmail Icon" title="tung.le0319@gmail.com" width="100" height="100">
          </button></a>
          <a
            v-motion-slide-visible-top
                :delay="300"
          href="tel:2088905308" target="_blank" data-title="2088905308">  <button class="btn bg-transparent fs-1 font-1 ">
